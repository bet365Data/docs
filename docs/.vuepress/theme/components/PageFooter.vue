  ...
  <div class="content-wrapper">
    <div class="flex w-full items-center">
      ...
      <div class="footer-links">
        ...
        <p>
          <a href="https://t.me/Bet365Data/" target="_blank" rel="noopener">
        ...
        <p>
          <a href="https://help.bet365data.com/" target="_blank" rel="noopener">
            <span class="right-footer-icon">
              <Reply />
            </span>
            back to bet365data.com
          </a>
        </p>
...
export default {
  ...
  methods: {
    ...
    getIssueUrl() {
      return encodeURI(
        `https://github.com/${this.$themeConfig.docsRepo}/issues/new?title=Improve “${this.$page.title}”&body=I have a suggestion for http://help.bet365data.com${this.$route.fullPath}:\n`
      );
    },
  },
  watch: {
